...
%token IF ELSE FOR WHILE DO GOTO BREAK CONTINUE INT FLOAT CHAR VOID DOUBLE SWITCH CASE DEFAULT PRINTF RETURN ADDOP MULOP INCOP DECOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD COLON SEMICOLON COMMA ID CONST_INT CONST_FLOAT
...
int main(int argc, char *argv[])
{
    ...
    yyin = fopen(argv[1], "r");
    outlog.open("22101583.txt", std::ios::trunc);
    ...
    outlog << "Total no of lines : " << lines << std::endl;
